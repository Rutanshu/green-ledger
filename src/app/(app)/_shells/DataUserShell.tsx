...
import { Home, ListChecks, FileEdit, Upload, FileText, Building2, HelpCircle } from "lucide-react";
import { signOut } from "../../login/actions";
import type { Role } from "@/lib/auth/permissions";

type NavItem = { href: string; label: string; icon: ComponentType<{ className?: string }> };

const NAV_DATA_INPUTTER: readonly NavItem[] = [
  { href: "/", label: "Home", icon: Home },
  { href: "/tasks", label: "My Tasks", icon: ListChecks },
  { href: "/enter-data", label: "Enter Data", icon: FileEdit },
...
const NAV_READ_ONLY: readonly NavItem[] = [
  { href: "/", label: "Home", icon: Home },
  { href: "/sites", label: "Facilities", icon: Building2 },
  { href: "/data-collection", label: "Data", icon: FileEdit },
  { href: "/help", label: "Help", icon: HelpCircle },
];
